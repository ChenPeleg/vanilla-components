...
class ExamplesPage extends BaseElement {
    ...
    renderTemplate() {
        ...
        this.shadowRoot!.innerHTML = `
            <docs-page-layout title="Practical Examples" bg="bg-fuchsia-100" intro="Explore real-world examples demonstrating key patterns and features of Vanilla Components. Each example includes complete, working code that you can use as a starting point for your own components.">
